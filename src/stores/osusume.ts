...
const spreadSheetUrl = "https://script.google.com/macros/s/AKfycbxsZtN8gOaTLcMc3o2KNU0BY9Ufxkd57Nqo8KaxmQBlJEG_1kGjTgxtSKvU9IWNBL7X/exec";
...
export class OsusumeStore{
    ...
    constructor(caller: ()=>OsusumeStore){
        if (caller == OsusumeStore.getInstance){
            ...
            throw new Error("Already created instance of OsusumeStore. You should use OsusumeStore.getInstance().")
        }else{
            throw new Error("Constractor args valided illegal. You should use OsusumeStore.getInstance()")
        }
    }
}
